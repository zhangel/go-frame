...
var compactFlags []string

func init() {
	declare.Flags("",
		declare.Flag{Name: flagVerbose, DefaultValue: false, Description: "Show verbose usage message."},
	)
	...
	declare.Flags(configPrefix,
		...
		declare.Flag{Name: flagPassword, DefaultValue: "", Description: "Comma-separated password list which used to encrypt config value."},
...
func populateFlags(source declare.ModifiableConfigSource, compactUsage bool, flagsToShow, flagsToHide []string) {
...
func PrepareConfigs(beforeConfigPrepareHook []func(), configPreparer func(config.Config) (config.Config, error), configSources []config.Source, compactUsage bool, flagsToShow, flagsToHide []string) {
